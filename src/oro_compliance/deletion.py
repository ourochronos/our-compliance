    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "key_revocation_timestamp": (
                self.key_revocation_timestamp.isoformat() if self.key_revocation_timestamp else None
            ),
...
def get_deletion_verification(tombstone_id: UUID) -> dict[str, Any] | None:
    ...
    with get_cursor() as cur:
        ...
        return {
            ...
            "key_revocation_timestamp": (
                tombstone.key_revocation_timestamp.isoformat() if tombstone.key_revocation_timestamp else None
            ),
            "propagation_status": {
